...
(@include_once(_AF_CONFIG_DATA_ . '_db_config.php')) OR die("ALEC BOARD를 이용하시기 전 <a href=\"./install/\">설치</a>해주세요.");
...
if(DB::error()) exit("DB에 문제가 발생하였습니다. ALEC BOARD를 다시 설치해주세요.");
